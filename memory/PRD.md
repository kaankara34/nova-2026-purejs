...
- **East West floor-plan section:** content-driven height, no viewport heights. Plan image capped at `clamp(360px, 46vh, 470px)` desktop / 58vh tablet / 50vh mobile, `object-fit: contain`, aspect always preserved. Section = 738px at 1920×1080 (68% viewport / 79% below navbar) and 683px at 1440×900 (76% / 91%), down from ~1000/952. The 14-row table at readable 13px is the height floor, so 1440×900 sits above the requested 70–78% below-navbar band.
