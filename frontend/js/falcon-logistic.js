...
(function () {
  ...
  /* ========== Lightbox Gallery (finger-tracking swipe) ==========
     ...
     Both #ewGalleryBtn, #ewGalleryTrigger and .flogistic-view-all-btn open this
  ...
  const manifestoImgs = $$('.flogistic-manifesto-img img');
  const featureImgs   = $$('.flogistic-features-img img');
  ...
  $$('.flogistic-view-all-btn').forEach(btn => {
  ...
  /* ========== FAQ accordion ========== */
  const faqList = $('#flogisticFaqList');
  if (faqList) {
    $$('.flogistic-faq-q', faqList).forEach(btn => {
      btn.addEventListener('click', () => {
        const item = btn.parentElement;
        const answer = item.querySelector('.flogistic-faq-a');
        const expanded = btn.getAttribute('aria-expanded') === 'true';
        // Close others
        $$('.flogistic-faq-q', faqList).forEach(b => {
          if (b !== btn) {
            b.setAttribute('aria-expanded', 'false');
            const a = b.parentElement.querySelector('.flogistic-faq-a');
