...
(function () {
  ...
  /* ========== Lightbox Gallery (finger-tracking swipe) ==========
     ...
     Both #ewGalleryBtn, #ewGalleryTrigger and .konelsis-view-all-btn open this
  ...
  const manifestoImgs = $$('.konelsis-manifesto-img img');
  const featureImgs   = $$('.konelsis-features-img img');
  ...
  $$('.konelsis-view-all-btn').forEach(btn => {
  ...
  /* ========== FAQ accordion ========== */
  const faqList = $('#konelsisFaqList');
  if (faqList) {
    $$('.konelsis-faq-q', faqList).forEach(btn => {
      btn.addEventListener('click', () => {
        const item = btn.parentElement;
        const answer = item.querySelector('.konelsis-faq-a');
        const expanded = btn.getAttribute('aria-expanded') === 'true';
        // Close others
        $$('.konelsis-faq-q', faqList).forEach(b => {
          if (b !== btn) {
            b.setAttribute('aria-expanded', 'false');
            const a = b.parentElement.querySelector('.konelsis-faq-a');
