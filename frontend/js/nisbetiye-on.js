...
(function () {
  ...
  /* ========== Lightbox Gallery (finger-tracking swipe) ==========
     ...
     Both #ewGalleryBtn, #ewGalleryTrigger and .nisbetiye-view-all-btn open this
  ...
  const manifestoImgs = $$('.nisbetiye-manifesto-img img');
  const featureImgs   = $$('.nisbetiye-features-img img');
  ...
  $$('.nisbetiye-view-all-btn').forEach(btn => {
  ...
  /* ========== FAQ accordion ========== */
  const faqList = $('#nisbetiyeFaqList');
  if (faqList) {
    $$('.nisbetiye-faq-q', faqList).forEach(btn => {
      btn.addEventListener('click', () => {
        const item = btn.parentElement;
        const answer = item.querySelector('.nisbetiye-faq-a');
        const expanded = btn.getAttribute('aria-expanded') === 'true';
        // Close others
        $$('.nisbetiye-faq-q', faqList).forEach(b => {
          if (b !== btn) {
            b.setAttribute('aria-expanded', 'false');
            const a = b.parentElement.querySelector('.nisbetiye-faq-a');
